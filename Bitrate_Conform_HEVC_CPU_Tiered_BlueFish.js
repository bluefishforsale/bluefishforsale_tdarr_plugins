...
const details = () => {
  return {
    id: "Bitrate_Conform_HEVC_CPU_Tiered_BlueFish",
    Stage: 'Pre-processing',
    Name: "BlueFish Tiered H265 MKV, remove audio & subtitles [CPU]",
    Stage: "Pre-processing",
    Type: "Video",
    Operation: "Transcode",
    Description:
    ...
    Version: "2.0",
    Tags: "pre-processing,ffmpeg,CPU h265",
    Inputs: [
      {
  ...
  function videoProcess(stream, id) {
    ...
    if (stream.codec_name === "png") {
      ...
      if (bitrateprobe !== null && parseInt(bitrateprobe) < parseInt(bitratecheck) && (file.video_codec_name !== "hevc" && file.container !== "mkv")) {
        ...
        logger.AddError("Transcoding to HEVC using CPU");
      }
    }
  }
